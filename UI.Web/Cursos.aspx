...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="formPanel" Visible="false" runat="server" Height="191px">
            ...
            <asp:RequiredFieldValidator id="validatorIdMateria" ControlToValidate="IdMateriaTextBox" ErrorMessage="Debe ingresar un IdMateria." Display="Static" InitialValue="" Width="1%" runat="server" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
            ...
            <asp:RequiredFieldValidator id="validatorIdComision" ControlToValidate="IdComisionTextBox" ErrorMessage="Debe ingresar un IdComision." Display="Static" InitialValue="" Width="1%" runat="server" ForeColor="Red">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="AnioCalendarioLabel" runat="server" Text="Anio de Calendario: "></asp:Label>
            <asp:TextBox ID="AnioCalendarioTextBox" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator id="validatorAnioCalendario" ControlToValidate="AnioCalendarioTextBox" ErrorMessage="Debe ingresar un anio." Display="Static" InitialValue="" Width="1%" runat="server" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <asp:Panel ID="formActionsPanel" runat="server" Height="35px">
